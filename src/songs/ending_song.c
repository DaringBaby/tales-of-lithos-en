...
static const unsigned char* const order1[] = {P8,P0,P4,P4};
static const unsigned char* const order2[] = {P9,P1,P5,P5};
static const unsigned char* const order3[] = {P10,P2,P6,P6};
static const unsigned char* const order4[] = {P10,P3,P7,P15};
...
const hUGESong_t ending_song = {7, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
